...
0.8 # SPR target (e.g. 0.40)
0.8 # Biomass target (e.g. 0.40)
...
0.8 # Control rule Biomass level for constant F (as frac of Bzero, e.g. 0.40); (Must be > the no F level below) 
0.4 # Control rule Biomass level for no F (as frac of Bzero, e.g. 0.10) 
