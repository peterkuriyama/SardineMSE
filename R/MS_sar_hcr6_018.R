#' Code to run harvest control rule 6 for sardine based on the 40-10 rule, where the Blim is 10% of equilibrium unfished SSB and 
#' the Bthreshold is 40% of equilibrium unfished SSB. The Ftarget is a harvest rate of 0.18 (Emsy) of the biomass estimated from the EM
...
MS_sar_hcr6_018 = function(EM_out_dir = NULL, 
  ...
  B0=EMcdat$derived_quants$Value[EMcdat$derived_quants$Label=="SSB_unfished"]
  B040=0.4*B0
  B010=0.1*B0
  ...
  if (Bcur > B040) {Ftar = Emsy } else if (Bcur < B040 & Bcur >B010)
  {Ftar = (Emsy/(B040-B010))*(Bcur-B010)} else {Ftar = 0}
