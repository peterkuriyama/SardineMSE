#' Code to run harvest control rule 5 for sardine based on the Pikitch et al. 2012 rule, where the Blim is 40% of equilibrium unfished SSB and 
#' the Bthreshold is 80% of equilibirium unfished SSB. The Ftarget is a harvest rate of 0.18 (Emsy) of the biomass estimated from the EM
...
MS_sar_hcr5_018 = function(EM_out_dir = NULL, 
