#' Code to run harvest control rule 6 for sardine based on the 40-10 rule, where the Blim is 10% of dynamic unfished SSB and 
#' the Bthreshold is 40% of dynamic unfished SSB. The Ftarget is a harvest rate of 0.18 (Emsy) of the biomass estimated from the EM
...
MS_sar_hcr8_018 = function(EM_out_dir = NULL, 
  ...
  {Ftar = (Emsy/(B040d-B010d))*(Bcur-B010d)} else {Ftar = 0}
