...
sample_struct_list <- list("annChange5pctModel" = sample_struct)
# Run the OM --------------------------------------------------------------
...
run_SSMSE(scen_name_vec = "annChange5pctModel",# name of the scenario
...
recrDiagPlots(dir = "C:/Users/rwildermuth/Documents/FutureSeas/SardineMSE/cohortGrowthOMfixedParamsEM",
              scenario = "annChange5pctModel", termYr = 2028)
