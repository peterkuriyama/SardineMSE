#' Code to run harvest control rule 5 for sardine based on the Pikitch et al. 2012 rule, where the Blim is 40% of dynamic unfished SSB and 
#' the Bthreshold is 80% of dynamic unfished SSB. The Ftarget is a harvest rate of 0.18 (Emsy) of the biomass estimated from the EM
...
MS_sar_hcr7_018 = function(EM_out_dir = NULL, 
  ...
  if (Bcur > B080d) {Ftar = Emsy } else if (Bcur < B080d & Bcur >B040d)
  {Ftar = (Emsy/(B080d-B040d))*(Bcur-B040d)} else {Ftar = 0}
